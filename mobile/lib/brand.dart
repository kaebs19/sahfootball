...
class Brand {
  ...
  /// مباشر — النبضة والدقيقة وشارة «مباشر» على المباراة الجارية.
  ///
  /// أخضر لا أحمر (قرار محمد 2026-09-06): الأحمر عندنا يعني «خطأ»
  /// و«خطر»، فكانت المباراة الحيّة تبدو كأن شيئاً فيها معطّل. الأخضر
  /// هو لون «يحدث الآن» في البثّ والتطبيقات المشهورة. وهو نفس درجة
  /// «صح» عمداً كي لا يتكاثر الأخضر بدرجات — لكنه رمز مستقل ليبقى
  /// تغييره يوماً تغييراً في سطر واحد.
  static const live = Color(0xFF12E07E);
