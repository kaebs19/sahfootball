...
const SIMPLE = [
  ...
  // نقاط الإضافة: ترتيب أفضل ثلاثة في المباراة يحسبه المؤشّر في
  // الشيفرة، وما يناله كلٌّ منهم يُضبط من هنا.
  { key: 'bonus_first', label: 'إضافة: أفضل لاعب في المباراة' },
  { key: 'bonus_second', label: 'إضافة: الثاني' },
  { key: 'bonus_third', label: 'إضافة: الثالث' },
];
